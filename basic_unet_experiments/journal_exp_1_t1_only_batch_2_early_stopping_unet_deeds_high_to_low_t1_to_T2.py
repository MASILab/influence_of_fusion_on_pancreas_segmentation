...
my_experiment_name = "journal_exp_1_t1_only_fold_{}_batch_2_early_stopping_unet_deeds_high_to_low_t1_to_T2".format(fold)
...
class Dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, _index):
        ...
        X = nib.load(datapoint["deeds_high_to_low_t1_reoriented_to_LAS_regrid_to_t2_space"])
        X = X.get_fdata()
